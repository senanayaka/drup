...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:2839roe8FOFo@localhost/drup?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:2839roe8FOFo@localhost/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/media/parakrama/2bc230ab-5889-45c9-8cab-a28f0fa52cf01/drupal/drupal-7.0/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/media/parakrama/2bc230ab-5889-45c9-8cab-a28f0fa52cf01/drupal/drupal-7.0/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost:8888/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'a0dcd63a9b390322e09ebb04075bbff7');
}
...
// define( 'CIVICRM_MAIL_LOG', '/media/parakrama/2bc230ab-5889-45c9-8cab-a28f0fa52cf01/drupal/drupal-7.0/sites/default/files/civicrm/templates_c//mail.log');
// }
